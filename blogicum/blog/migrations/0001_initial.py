# Generated by Django 3.2.16 on 2023-04-26 16:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Идентификатор страницы для URL; разрешенные символы            латиницы, цифры, дефис и подчёркивание', unique=True, verbose_name='Идентификатор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Усли установит дату и время в будущем - можно делать            отложенные публикации', verbose_name='Дата и время публикации')),
